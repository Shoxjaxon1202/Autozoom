          ...
          <div className="about__top">
            ...
            <div className="about__welcome">
              ...
              <p className="about__text">
                In a world where every trip is an adventure, Auto Zoom Car
                Rental Co LLC offers you a unique car rental experience in the
                heart of Dubai.
              </p>
            </div>
            <div className="about__why">
              ...
              <div className="about__desc">
                ...
                <p className="about__text">
                  We provide you the opportunity to choose from our luxurious
                  car fleet – from sleek sedans to powerful SUVs. We have a
                  vehicle to match your style and meet your needs.
                </p>
              </div>
              <div className="about__desc">
              ...
              <div className="about__desc">
                ...
                <p className="about__text">
                  ...
                  transparent. No hidden fees, no unexpected surprises. Trust
                  us, and we will make your rental experience straightforward
                  and clear.
                </p>
              </div>
              <div className="about__desc">
                ...
                <p className="about__text">
                  Our friendly and professional team is ready to bring your
                  ideas to life. We aim not just to provide a car but to create
                  a genuine automotive experience for you.
                </p>
              </div>
            </div>
          </div>
